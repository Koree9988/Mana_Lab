...
//NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
const char FIREBASE_HOST[]  = "smartbus-7lpin5zc7a-as.a.run.app";
const String FIREBASE_AUTH  = "ENTER_FIREBASE_AUTH";
const String FIREBASE_PATH  = "/api/v1/signage/2/arrival?fbclid=IwAR0nsIosXG3b-clGm0tdmfStC8ZFTFsUb_rrPsikMAoIy7hiC8S_xhvkL_s";
